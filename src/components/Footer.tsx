    ...
    <footer className="mt-auto border-t border-white/10 bg-[#030914]">
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="flex flex-col justify-between gap-6 lg:flex-row">
          <div>
            <p className="font-black text-white">UDoChain Escrow Challenge</p>
            <p className="mt-1 text-sm text-slate-400">World Cup Edition · Conditional escrow technology demo</p>
          </div>
